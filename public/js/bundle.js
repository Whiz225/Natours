...
exports.upadateSettings = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alert = require("./alert");
function _interopRequireDefault(e) { return e && e.__esModule ? e : { default: e }; }
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; }
var upadateSettings = exports.upadateSettings = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(data, type) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          url = type === 'password' ? "http://127.0.0.1:3000/api/v1/user/updatepassword" : "http://127.0.0.1:3000/api/v1/user/updateMyData";
          _context.next = 4;
          return (0, _axios.default)({
            method: 'PATCH',
            url: url,
  ...
  return function upadateSettings(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; }
var stripe = Stripe('pk_test_51QoTfMIvMUQMPCwoO03G8sbOdY68YNsUkzeNOGurtyLupLnO8dO3hiz4ciJWg5ai8eVBEG6K6MoFhov2mhoc0OjE00xbmVyBE8');
...
exports.addReview = exports.addNewReview = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alert = require("./alert");
function _interopRequireDefault(e) { return e && e.__esModule ? e : { default: e }; }
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; }
var addReview = exports.addReview = function addReview(user) {
  var html = "<div class=\"reviews__card\">\n          <div class=\"reviews__avatar\">\n            <img\n              src=\"img/users/".concat(user.photo, "\"\n              alt=").concat(user.name, "\n              class=\"reviews__avatar-img\"\n            />\n            <h6 class=\"reviews__user\">").concat(user.name, "</h6>\n          </div>\n          <input class=\"reviews__text\" type=\"text\" placeholder=\"Your review\" required>\n          <div class=\"reviews__rating\">\n            <svg class=\"reviews__star reviews__star--active\">\n              <use xlink:href=\"img/icons.svg#icon-star\"></use>\n            </svg>\n            <svg class=\"reviews__star reviews__star--active\">\n              <use xlink:href=\"img/icons.svg#icon-star\"></use>\n            </svg>\n            <svg class=\"reviews__star reviews__star--active\">\n              <use xlink:href=\"img/icons.svg#icon-star\"></use>\n            </svg>\n            <svg class=\"reviews__star reviews__star--active\">\n              <use xlink:href=\"img/icons.svg#icon-star\"></use>\n            </svg>\n            <svg class=\"reviews__star reviews__star--active\">\n              <use xlink:href=\"img/icons.svg#icon-star\"></use>\n            </svg>\n          </div>\n          <div class='btn button'>\n          <button class='btn--green btn--small btn--add'>&#10148;</button>\n          <button class='btn--green btn--small btn--close'>&times;</button>\n          </div>\n          </div>\n        </div>");
  return html;
};
var addNewReview = exports.addNewReview = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(tour, review) {
    var newReview;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
        ...
        case 3:
          ...
          (0, _alert.showAlert)('success', 'Successfully updated');
  ...
  return function addNewReview(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
...
var addReviewBtn = document.querySelector('.btn--add-review');
var updateUserSettingsForm = document.querySelector('.form-user-settings');
...
if (updateUserSettingsForm) updateUserSettingsForm.addEventListener('submit', /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 7;
          return (0, _updateSettings.upadateSettings)({
...
if (updateUserDataForm) updateUserDataForm.addEventListener('submit', function (e) {
  ...
  (0, _updateSettings.upadateSettings)(form, 'data');
});
...
if (addReviewBtn) addReviewBtn.addEventListener('click', function (e) {
  var reviews = document.querySelector('.reviews').querySelector('.reviews__card');
  var userObj = e.target.dataset;
  var user = JSON.parse(userObj.user);
  var tourId = userObj.tourId;
  var html = (0, _reviews.addReview)(user);
  reviews.insertAdjacentHTML('beforebegin', html);
  var addBtn = document.querySelector('.btn--add');
  var closeBtn = document.querySelector('.btn--close');
  if (addBtn) addBtn.addEventListener('click', /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(e) {
      var myReview;
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            myReview = document.querySelector('.reviews__text').value;
            _context2.next = 3;
            return (0, _reviews.addNewReview)(tourId, myReview);
          case 3:
          case "end":
            return _context2.stop();
        }
